      ...
      <div className={classes.FooterWrapper}>
        ...
        <div className={classes.FooterContainer}>
          ...
          <div className={classes.FooterLinks}>
            ...
            <div><Link to={`#`}>Пункты выдачи</Link></div>
          </div>
        </div>
        <div className={classes.FooterContainer}>
          <div className={classes.FooterHeading}>Покупателям</div>
          <div className={classes.FooterLinks}>
            <div><Link to={`#`}>Связаться с нами</Link></div>
            <div><Link to={`#`}>Как сделать заказ?</Link></div>
            <div><Link to={`#`}>Как оплатить</Link></div>
            <div><Link to={`#`}>Доставка</Link></div>
            <div><Link to={`#`}>Возврат</Link></div>
            <div><Link to={`#`}>Вопрос-ответ</Link></div>
          </div>
        </div>
        <div className={classes.FooterContainer}>
          ...
          <div className={classes.FooterLinks}>
            ...
            <div><Link to={`#`}>Продавайте на маркете</Link></div>
            <div><Link to={`#`}>Документация для партнёров</Link></div>
            <div><Link to={`#`}>Вопрос ответ</Link></div>
          </div>
        </div>
